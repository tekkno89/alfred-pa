...
import type { TokenResponse, User, UserRegister } from '@/types'
...
export function RegisterForm() {
  ...
  const registerMutation = useMutation({
    mutationFn: async (credentials: UserRegister) => {
      const tokenResponse = await apiPost<TokenResponse>('/auth/register', credentials)
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>Sign up to start using Alfred</CardDescription>
      </CardHeader>
